...
| 4 | Bấm **Liên hệ** | Hiện SĐT chủ hàng (không có SĐT trước khi contact) | |
...
| 10 | Tạo trip hướng không có hàng (ví dụ Thanh Hóa → Vinh) → quét radar | **Empty state** với 3 gợi ý (nới tuyến / khai báo chiều về / thử lại sau) | |
